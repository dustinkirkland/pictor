...
function get_next_link($album, $width, $pictures, $currentindex, $slideshow) {
	...
	$next = "<table border=0><tr><td bgcolor=white><a href='$url'><b>Next <img src=icons/resultset_next.png></b></a></td></tr></table>";
	return $next;
}
...
function get_back_link($album, $width, $pictures, $currentindex) {
	if ($currentindex != 0) {
		...
		$back = "<table border=0><tr><td bgcolor=white><a href='$url'><b><img src=icons/resultset_previous.png> Back</b></a></td></tr></table>";
		return $back;
	} else {
		return "&nbsp;";
	}
